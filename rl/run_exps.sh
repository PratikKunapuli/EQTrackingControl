...
#     "--env-name astrobee_random_walk --exp-name RUN_EXPS_astrobee_random_walk --num-seeds 1 --equivariant 0 --symmetry_type 2 --lr 3e-4 --num-envs 32 --num-steps 512 --total-timesteps 20e6 --activation leaky_relu --out-activation hard_tanh --reward_q_pos 1e-2 --reward_q_vel 1e-3 --reward_q_rotm 10.0 --reward_q_omega 5e-2 --reward_r 1e-3 --reward_reach --terminal-reward -25.0 --quad-model FAQuad --num-layers 6 --num-nodes 128"
...
#     "--env-name quadrotor_random_walk --exp-name RUN_EXPS_quadrotor_random_walk --num-seeds 1 --equivariant 0 --lr 3e-4 --num-envs 64 --num-steps 512 --total-timesteps 10e8 --activation leaky_relu --out-activation clipped_relu --reward_q_pos 2e-2 --reward_q_vel 1e-3 --reward_q_rotm 0.6 --reward_q_omega 1e-4 --reward_r 5e-4 --reward_reach --terminal-reward -25.0 --num-layers 6 --num-nodes 128"
#     "--env-name quadrotor_random_walk --exp-name RUN_EXPS_quadrotor_random_walk_equivariant --num-seeds 1 --equivariant 1 --lr 3e-4 --num-envs 64 --num-steps 512 --total-timesteps 10e8 --activation leaky_relu --out-activation clipped_relu --reward_q_pos 2e-2 --reward_q_vel 1e-3 --reward_q_rotm 0.6 --reward_q_omega 1e-4 --reward_r 5e-4 --reward_reach --terminal-reward -25.0 --num-layers 6 --num-nodes 128"
# )
...
# TRAIN_ARGS=(
#     "--env-name quadrotor_random_walk --exp-name TEST_quadrotor_random_walk --num-seeds 1 --equivariant 0 --lr 3e-4 --num-envs 64 --num-steps 512 --total-timesteps 10e7 --activation leaky_relu --out-activation clipped_relu --reward_q_pos 2e-2 --reward_q_vel 1e-3 --reward_q_rotm 0.6 --reward_q_omega 1e-4 --reward_r 5e-4 --reward_reach --terminal-reward -25.0 --num-layers 6 --num-nodes 128"
#     "--env-name quadrotor_random_walk --exp-name TEST_quadrotor_random_walk_equivariant --num-seeds 1 --equivariant 1 --lr 3e-4 --num-envs 64 --num-steps 512 --total-timesteps 10e7 --activation leaky_relu --out-activation clipped_relu --reward_q_pos 2e-2 --reward_q_vel 1e-3 --reward_q_rotm 0.6 --reward_q_omega 1e-4 --reward_r 5e-4 --reward_reach --terminal-reward -25.0 --num-layers 6 --num-nodes 128"
# )
...
#python3 train_policy.py --env-name astrobee_random_walk --exp-name RUN_EXPS_astrobee_random_walk_equivariant_symm2 --num-seeds 1 --equivariant 1 --symmetry_type 2 --lr 3e-4 --num-envs 32 --num-steps 512 --total-timesteps 20e6 --activation leaky_relu --out-activation hard_tanh --termination-bound 25.0 --reward_q_pos 5e-2 --reward_q_vel 1e-3 --reward_q_rotm 10.0 --reward_q_omega 5e-2 --reward_r 1e-3 --reward_reach --terminal-reward -25.0 --quad-model FAQuad --num-layers 6 --num-nodes 256