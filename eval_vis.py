...
# def baseline_model_call(params, obs):
#     pi, value = baseline_model.apply({'params': params}, obs)
#     action = pi.mean()
#     # action = pi.sample(seed=0)
#     return action

# def equivariant_model_call(params, obs):
#     pi, value = equivariant_model.apply({'params': params}, obs)
#     action = pi.mean()
#     # action = pi.sample(seed=0)
#     return action
